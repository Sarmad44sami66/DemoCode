        ...
        <Item
          ...
          onPress={() =>
            Share.share({
              ...
              })\n${"- Only for "}${getString("pointWithCount", {
                count: model.points,
              })}`,
            })
          }
      ...
      >
        ...
        <SectionContent title={getString("Location")}>
          <TouchableOpacity
            onPress={() =>
              Linking.openURL(
                `https://www.google.com/maps/dir/?api=1&travelmode=driving&layer=traffic&destination=${model.latitude},${model.longitude}`
              )
            }
          >
