...
import { REGISTRATION057_PROP_CHANGED, PAYMENTSCREEN400_PROP_CHANGED, REGISTRATION057_PROP_CLEAR, Registration0571_Api_Call } from '../../actions/Actions';
...
class Registration057 extends Component {
    ...
    onSuccess = (response)=> {
        ...
        if(response.data){
            let data = [];
            if(Preference.get(mystorage.CARD_LIMIT) == 0){
            ...
            Preference.set(mystorage.CARD_PRIMARY, data.length - 1)
            Preference.set(mystorage.CARD_OBJECT, data);
            this.props.propChanged(PAYMENTSCREEN400_PROP_CHANGED, "selectedIndex", data.length - 1);
            this.props.propChanged(PAYMENTSCREEN400_PROP_CHANGED, "radioOptions", data);
                    ...
                    <KeyboardAwareScrollView
                        ...
                        <View style={{width: '100%', justifyContent: 'center', alignItems: 'center'}}>
                            <View style={{justifyContent:"center", alignItems: 'center', width:"80%"}}>
                                ...
                                <View style={[styles.forminputContainer, { marginTop: 70}]}>
                                    <TextInput
...
const mapStateToProps = ({Registration057State, PaymentScreen400State}) => {
    const { loading, creditCardNumber, expiryDate, CVVOrCVC, nameOnCard, isFrom72, isConnected} = Registration057State;
    const { radioOptions, selectedIndex } = PaymentScreen400State;
    return {
        loading, creditCardNumber, expiryDate, CVVOrCVC, nameOnCard, isFrom72, 
        radioOptions, selectedIndex, isConnected
    };
};

export default connect(mapStateToProps, {Registration0571_Api_Call, propChanged, propsClear})(Registration057)