...
export default class Registration059 extends Component {
    constructor(props) {
        super(props);
        this.state = {
            loading: false,
                ...
                <View style={styles.container}>
                            ...
                            <Text style={{fontFamily: 'HelveticaNeue-Medium', textAlign: 'center', fontSize: 24}}>
                                {
                                    ...
                                    'not available in (' + this.state.city + '),\n' +
                    ...
                    <View style={styles.navigationButtonsContainer}>
                        <TouchableOpacity 
                            ...
                            <Text style={{fontFamily: 'HelveticaNeue-Light', fontSize: 16, color: '#fff'}}>Ok</Text>
                        </TouchableOpacity>
                    </View>
                </View>
            </SafeAreaView>
