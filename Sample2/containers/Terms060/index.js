...
export default class Terms060 extends Component {
    constructor(props) {
        super(props);
        this.state = {
            loading: false,
                ...
                <View style={styles.container}>
                    ...
                    <View style={{justifyContent:"center", alignItems: 'center', width:width}}>
                        <View style={{justifyContent:"center", alignItems: 'center', width:"80%"}}>
                            <Text style={{fontFamily: 'HelveticaNeue-Light', textAlign: 'center', fontSize: 18, marginBottom: 40}}>{'Privacy policy'}</Text>
                        </View>
                    </View>
                </View>
            </SafeAreaView>
