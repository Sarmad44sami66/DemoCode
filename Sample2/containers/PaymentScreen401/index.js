...
class PaymentScreen401 extends Component {
    ...
    onSelectButtonPress () {
        ...
        this.props.screenIDHandler(400)
    }
            ...
            <SafeAreaView style={{flex:1}}>
                <View style={styles.container}>
                    <View style={{width: width, height: 55, alignItems: 'center', justifyContent: 'center', flexDirection: 'row', marginBottom: 20, backgroundColor: '#F8F8F8'}}>
                        ...
                        <TouchableOpacity 
                            ...
                            onPress={()=>{
                                ...
                                else this.props.screenIDHandler(402)
                            }}>
                            <Text style={{fontFamily: 'HelveticaNeue-Medium', color: '#007AFF', fontSize: 17, marginEnd: 5}}>
                                {(this.props.radioOptions.length > 0) ? 'Select' : 'Add Card'}
                            </Text>
                    ...
                    <Text style={{color: '#9A9A9A', fontFamily: 'HelveticaNeue-Medium', textAlign: 'center', fontSize: 20}}>
                        {((this.props.radioOptions.length > 0) ? 'Select' : 'Add')+ ' payment method:'}
                    </Text>
                        ...
                        <View style={{flexGrow:1, width: '100%', justifyContent: 'center', alignItems: 'center'}}>
                            ...
                            {(this.props.radioOptions.length > 0) &&
                                <TouchableOpacity
                                    style={{ margin:20}}
                                    onPress={()=>{
                                        this.props.screenIDHandler(402)
                                    }}>
                            ...
                            <View style={styles.navigationButtonsContainer}>
                                <TouchableOpacity 
                                    ...
                                    <Text style={{fontFamily: 'HelveticaNeue-Light', fontSize: 16, color: '#fff'}}>
                                        {(this.props.radioOptions.length > 0) ? 'Select' : 'Add Card'}
                                    </Text>
                                </TouchableOpacity>
                            </View>
...
export default connect(mapStateToProps, {propChanged, propsClear})(PaymentScreen401)